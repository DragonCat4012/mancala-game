...
class SowServiceTests {
    ...
    void testSampleSowsCheckRolesAndTurn() {
        ...
        Assertions.assertThat(this.game.getPits().toString())
        ...
        this.game = sowService.sow(this.game, 9);
        Assertions.assertThat(this.game.getPits().toString())
                .isEqualTo("[1:8, 2:1, 3:0, 4:9, 5:9, 6:2, 7:3, 8:10, 9:0, 10:10, 11:10, 12:8, 13:0, 14:2]");
        Assertions.assertThat(this.game.getPlayerTurn()).isEqualTo(PlayerTurnEnum.FIRST_PLAYER);
    
        //capture opposite for First Player
        this.game = sowService.sow(this.game, 2);
        Assertions.assertThat(this.game.getPits().toString())
                .isEqualTo("[1:8, 2:0, 3:0, 4:9, 5:9, 6:2, 7:14, 8:10, 9:0, 10:10, 11:0, 12:8, 13:0, 14:2]");
        Assertions.assertThat(this.game.getPlayerTurn()).isEqualTo(PlayerTurnEnum.SECOND_PLAYER);
    
        this.game = sowService.sow(this.game, 8);
        Assertions.assertThat(this.game.getPits().toString())
                .isEqualTo("[1:9, 2:1, 3:1, 4:10, 5:9, 6:2, 7:14, 8:0, 9:1, 10:11, 11:1, 12:9, 13:1, 14:3]");
        Assertions.assertThat(this.game.getPlayerTurn()).isEqualTo(PlayerTurnEnum.FIRST_PLAYER);
    
        this.game = sowService.sow(this.game, 1);
        Assertions.assertThat(this.game.getPits().toString())
                .isEqualTo("[1:0, 2:2, 3:2, 4:11, 5:10, 6:3, 7:15, 8:1, 9:2, 10:12, 11:1, 12:9, 13:1, 14:3]");
        Assertions.assertThat(this.game.getPlayerTurn()).isEqualTo(PlayerTurnEnum.SECOND_PLAYER);
    
        this.game = sowService.sow(this.game, 9);
        Assertions.assertThat(this.game.getPits().toString())
                .isEqualTo("[1:0, 2:2, 3:2, 4:11, 5:10, 6:3, 7:15, 8:1, 9:0, 10:13, 11:2, 12:9, 13:1, 14:3]");
        Assertions.assertThat(this.game.getPlayerTurn()).isEqualTo(PlayerTurnEnum.FIRST_PLAYER);
    
        this.game = sowService.sow(this.game, 2);
        Assertions.assertThat(this.game.getPits().toString())
                .isEqualTo("[1:0, 2:0, 3:3, 4:12, 5:10, 6:3, 7:15, 8:1, 9:0, 10:13, 11:2, 12:9, 13:1, 14:3]");
        Assertions.assertThat(this.game.getPlayerTurn()).isEqualTo(PlayerTurnEnum.SECOND_PLAYER);
    
        //Capture opposite for second player
        this.game = sowService.sow(this.game, 8);
        Assertions.assertThat(this.game.getPits().toString())
                .isEqualTo("[1:0, 2:0, 3:3, 4:12, 5:0, 6:3, 7:15, 8:0, 9:0, 10:13, 11:2, 12:9, 13:1, 14:14]");
        Assertions.assertThat(this.game.getPlayerTurn()).isEqualTo(PlayerTurnEnum.FIRST_PLAYER);
    
        this.game = sowService.sow(this.game, 3);
        Assertions.assertThat(this.game.getPits().toString())
                .isEqualTo("[1:0, 2:0, 3:0, 4:13, 5:1, 6:4, 7:15, 8:0, 9:0, 10:13, 11:2, 12:9, 13:1, 14:14]");
        Assertions.assertThat(this.game.getPlayerTurn()).isEqualTo(PlayerTurnEnum.SECOND_PLAYER);
    
        //check additional turn.
        this.game = sowService.sow(this.game, 13);
        Assertions.assertThat(this.game.getPits().toString())
                .isEqualTo("[1:0, 2:0, 3:0, 4:13, 5:1, 6:4, 7:15, 8:0, 9:0, 10:13, 11:2, 12:9, 13:0, 14:15]");
        Assertions.assertThat(this.game.getPlayerTurn()).isEqualTo(PlayerTurnEnum.SECOND_PLAYER);
